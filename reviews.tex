...
3. On page 6, the authors state that "While other such simplifications are also possible, [...]". This is quite vague. It would be good to either state what these simplifications are or to give a reference to where they can be found.
\texit{Discuss ESSs, defferable loads, devices with time dependent SoC constraints}
...
\sububsection{Response to Reviewers}
...
% 2) The authors are recommended to add a small illustrative example (e.g., 2 devices) in section III to demonstrate the aggregation method.
